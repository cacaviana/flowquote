  ...
  <header class="bg-white border-b px-6 py-4 flex justify-between items-center">
    <div class="flex items-center gap-3">
      ...
      <div>
        ...
        <p class="text-sm text-gray-500">Fluxos de agendamento e reservas</p>
      </div>
    </div>
  ...
  <main class="max-w-6xl mx-auto p-6">
    ...
    {:else if tab === 'flows'}
      ...
      <div class="grid grid-cols-3 gap-4 mb-6">
        <div class="bg-white rounded-lg border p-4">
          ...
          <p class="text-xs text-gray-500">Total de fluxos</p>
        </div>
        <div class="bg-white rounded-lg border p-4">
        ...
        <div class="bg-white rounded-lg border p-4">
          ...
          <p class="text-xs text-gray-500">Total reservas</p>
        </div>
      </div>
      ...
      {#if flows.length === 0}
        <div class="text-center py-12 bg-white rounded-lg border">
          ...
          <p class="text-gray-500 mb-3">Nenhum fluxo de agendamento</p>
    ...
    {:else if tab === 'bookings'}
      {#if schedulings.length === 0}
        <div class="text-center py-12 bg-white rounded-lg border">
          <p class="text-gray-500">Nenhuma reserva ainda</p>
        </div>
      {:else}
          ...
          <table class="w-full">
            <thead>
              <tr class="border-b bg-gray-50">
                ...
                <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase">Contato</th>
                <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase">Data / Hora</th>
                <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase">Status</th>
                <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase">Fluxo</th>
              </tr>
            </thead>
