...
<div class="min-h-screen bg-gray-50">
  <header class="bg-white border-b px-6 py-4 flex items-center justify-between">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h1 class="text-lg font-bold text-gray-900">Detalhe da demanda</h1>
    ...
    {:else if submission}
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-4">
          ...
          <!-- Respostas -->
          <div class="bg-white rounded-lg border p-5">
            <h3 class="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3">Reponses ({submission.answers.length})</h3>
            <div class="space-y-2">
        ...
        <div class="lg:col-span-2">
          <div class="bg-white rounded-lg border p-6">
            ...
            {:else}
              <p class="text-sm text-gray-500 italic">Aucun devis genere pour cette demande.</p>
            {/if}
          </div>
        </div>
      </div>
